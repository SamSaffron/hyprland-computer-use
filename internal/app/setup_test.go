...
func TestNativeBundleExtraction(t *testing.T) {
	...
	for _, path := range []string{"Makefile", "LICENSE", "THIRD_PARTY.md", "native/guard.cpp", "native/input_transaction.hpp", "native/setup_inspector.cpp", "native/version.cpp", "native/virtual-keyboard-unstable-v1.xml", "native/wlr-virtual-pointer-unstable-v1.xml"} {
