...
func TestNativeBundleExtraction(t *testing.T) {
	...
	for _, path := range []string{"Makefile", "native/guard.cpp", "native/version.cpp", "native/virtual-keyboard-unstable-v1.xml", "native/wlr-virtual-pointer-unstable-v1.xml"} {
